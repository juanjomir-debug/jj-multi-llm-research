#!/usr/bin/env node
/**
 * Publica hilos usando la API v1.1 de Twitter (funciona con Essential access)
 */
...
async function publishThread(tweets) {
  console.log('\n╔═══════════════════════════════════════════════════════════════╗');
  console.log('║  🧵 Twitter Thread Publisher (API v1.1)                       ║');
  console.log('╚═══════════════════════════════════════════════════════════════╝\n');
  ...
  for (let i = 0; i < tweets.length; i++) {
    ...
    try {
      ...
      // Usar API v1.1
      const result = await rwClient.v1.tweet(params);
